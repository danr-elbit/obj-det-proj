...
flags.DEFINE_string('data_dir',  # ''
                    'C:/Users/CUDA/Downloads/magic_box/'
...
flags.DEFINE_string('output_path', #''
                    'C:/Users/CUDA/Downloads/magic_box/tfrecords_new/'
                    , 'Path to output TFRecord')
flags.DEFINE_string('label_map_path', '../data/pascal_small_label_map.pbtxt',
                    'Path to label map proto')
flags.DEFINE_boolean('ignore_difficult_instances', True #False
                     ,'Whether to ignore difficult instances')
tf.app.flags.DEFINE_float(
    'test_percentage', 10.0,
    'Define the percentage of test data. The rest woulb be traindata.')
...
def _get_output_filename(output_dir, name, idx, type):
    return '%s/%s_%s_%03d.tfrecord' % (output_dir, name, type, idx)
